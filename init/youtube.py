...
translations = gettext.translation(
    "youtube", localedir="locales", languages=["it"])
...
print(_("[7] Download from link to better MP4"))
print(_("[8] Download from link to best quality with split*"))
print(_("[9] Download from best quality link with metadata*"))
print()
print()
print(_("[10] Downloading Playlist via file"))
print()
print()
print()
...
print("---------------------")
print()
print(_("[11] Download to MP3 HQ"))
print(_("[12] Download album to MP3 HQ with split*"))
print()
print(_("[13] Download MP3 via file"))
print()
print()
print()
print()
...
try:
    ...
    if youtube >= (14):
        ...
        os.system("python init\\youtube.py")
except NameError:
    print()
...
def main():
    ...
    if youtube == 7:
        link = input(_("Copy video or playlist link: "))
        fmt = "bestvideo[height<=1080][ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]"
        cmd = [ytdl, "-f", fmt, "--merge-output-format",
               "mp4", "-o", string1, link]
